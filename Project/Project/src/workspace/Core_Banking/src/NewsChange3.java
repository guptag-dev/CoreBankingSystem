...
/**
 * Servlet implementation class for Servlet: NewsChange3
 *
 */
 public class NewsChange3 extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			String news=request.getParameter("news4");
			query="update updates set updates.news4='"+news+"'";
