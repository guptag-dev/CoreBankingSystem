...
/**
 * Servlet implementation class for Servlet: DraftCancel
 *
 */
 public class DraftCancel extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else if(perarray[0]=='e')
			{
				...
				pw.println("<td align=top width=580><script language=Javascript>function validate(){	var myform = document.form1;			if(myform.Chequeno.value==\"\")	{		alert(\"Draft Number is the required Field\");		return false;	}		}</script><font size=5>Draft Cancellation</font>          <br><br><form action=\"DraftCancelled\" method=\"POST\" name=form1><table>	<td width=200>		<b>Draft No.:</b><br><br>	</td>	<td>			<input type=\"text\" name=Chequeno maxlength=20><br><br>			</td></table> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=Submit value=\"Submit\" onclick=\"return validate()\"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=reset value=\"Reset\"> </form></td>");
