...
/**
 * Servlet implementation class for Servlet: DebitVerify
 *
 */
 public class DebitVerify extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='e')
				...
				String amt = request.getParameter("bill");
				...
				ctx.setAttribute("user",acnum);
				ctx.setAttribute("bill",amt);
				ctx.setAttribute("idnum",idnum);
				...
				pw.println("</table><br><br><form action=\"DebitIssue\" method=\"POST\"><input type=\"submit\" value=\"Verified\" name=verify></form></td>");
				break;
				}
				if(!enter)
				{
