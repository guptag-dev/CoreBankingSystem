...
/**
 * Servlet implementation class for Servlet: UploadSign
 *
 */
 public class UploadSign extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]!='c')
			{
				...
				String No = request.getParameter("NoOfHolders");
				ctx.setAttribute("No",No);
				ctx.setAttribute("num",No);
				...
				pw.println(ex.getMessage());
						...
						pw.println("<td valign=\"top\" width=580><form name=\"mainForm\" method=\"post\" enctype=\"multipart/form-data\" action=\"AccountCreated\">	<input type=\"hidden\" name=\"hiddenParameter\" value=\"123\">	<p>File (only *.jpg case sensitive): <input type=\"file\" name=\"file\"></p>		<p><input type=\"submit\" value=\"Upload\"></p>	</form></td>  ");
						if(perarray[0]=='e')
