...
/**
 * Servlet implementation class for Servlet: AddBranch
 *
 */
 public class AddBranch extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='a')
			{
				...
				pw.println("<td valign=\"top\" width=580>Enter Branch Details:<br><br><form action=\"AddedBranch\" method=\"POST\">Branch Name:<input type=text name=brname><br><br>Branch Location:<input type=text name=brloc><br><input type=submit value=\"Add\"></form></td>");
