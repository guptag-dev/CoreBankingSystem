 ...
 *
 */
 public class Report extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else if(perarray[0]=='e')
			{
				...
				pw.println("<td valign=\"top\" width=580><b> <u>Reports Section </u></b> <br> <br><br><br> 1) <a href=\"DTR\">Daily Transaction Reports</a><br><br> 2) <a href=\"SR\">Monthly Loan EMI Status Report</a><br><br>3) <a href=\"LEMI\">Monthly Loan Sanction Report</a></td>");
