...
/**
 * Servlet implementation class for Servlet: VerifySignature
 *
 */
 public class VerifySignature extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='e')
				...
				pw.println("</table><br><br><form action=\"CloseConfirm\" method=\"POST\"><input type=\"submit\" value=\"Verified\" name=verify></form></td>");
				break;
				}
				if(!enter)
				{
