...
/**
 * Servlet implementation class for Servlet: NewsChange
 *
 */
 public class NewsChange extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			String news=request.getParameter("news1");
			query="update updates set updates.news1='"+news+"'";
