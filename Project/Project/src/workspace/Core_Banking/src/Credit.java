...
/**
 * Servlet implementation class for Servlet: Credit
 *
 */
 public class Credit extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else if(perarray[0]=='e')
			{
				...
				String abc="<td valign=top width=580><SCRIPT LANGUAGE=JavaScript>function validate(){   var myForm = document.form1;  if (myForm.user.value ==\"\")   {      alert(\"Enter your Account-Number\");    	return false;     } if (myForm.bill.value ==\"\")   {      alert(\"Enter Amount\");    	return false;     }}</SCRIPT>";
				pw.println(abc+"<br><br><form action=\"CreditIssue\" method=\"POST\" name=form1><font size=\"3\">Credit</font>          <br><br><table>	<td width=200 valign=\"top\">	<b>Account-Number:</b><br><br><b>Amount:</b>	</td>	<td><input type=\"text\" name=user><br><br>	<input type=\"text\" name=bill maxlength=20><br><br><input type=reset value=\"Reset\" name=btnd2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=\"Submit\" value=\"Credit\" name=btnd1 onclick=\"return validate()\">	</td></table> </form></td>");
