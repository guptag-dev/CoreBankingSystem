...
/**
 * Servlet implementation class for Servlet: NewsChange1
 *
 */
 public class NewsChange1 extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			String news=request.getParameter("news2");
			query="update updates set updates.news2='"+news+"'";
