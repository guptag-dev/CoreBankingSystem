...
/**
 * Servlet implementation class for Servlet: CreditDetails
 *
 */
 public class CreditDetails extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='c')
			{
				...
				pw.println("<td valign=\"top\" width=580><b> <u>View Credit Transactions </u></b> <br> <br><br><br>");
				query =" select * from credit where credit.user='"+per+"' order by credit.dot" ;
				rset = stmt.executeQuery(query);
				pw.println("<table><tr><td width=120  style=\"border:1px #000000 solid\" bgcolor=#b5b5b5><b>Date</b></td><td width=120 style=\"border:1px #000000 solid\" bgcolor=#b5b5b5><b>Credit Amount</b></td><td width=200 style=\"border:1px #000000 solid\" bgcolor=#b5b5b5  ><b>Initials</b></td></tr>");
				while(rset.next())
				{
					
					pw.println("<tr> <td width=120 style=\"border:1px #000000 solid\" >"+rset.getDate(3)+"</td><td width=120 style=\"border:1px #000000 solid\" >"+rset.getFloat(2)+"</td><td width=200 style=\"border:1px #000000 solid\"  >"+rset.getString(4)+"</td><td width=120 style=\"border:1px #000000 solid\" ></td> </tr>");
				}
