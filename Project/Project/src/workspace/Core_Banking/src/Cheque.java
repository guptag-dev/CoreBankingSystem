...
/**
 * Servlet implementation class for Servlet: Cheque
 *
 */
 public class Cheque extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='c')
			{
				...
				pw.println("<td valign=\"top\" width=580>Cheques Section<br><br>1) <a href=\"ChequeStatus\">View Cheque Status</a></td>");
			...
			else if(perarray[0]=='e')
			{
				...
				pw.println("<td valign=\"top\" width=580><b> <u>Cheques Section </u></b> <br> <br><br><br> 1) <a href=\"ChequeClear\">Cheque Clearing</a><br><br> 2) <a href=\"ChequeStatus\">Cheque Status</a><br><br>3) <a href=\"ChequeCancel\">Cheque Cancellation</a></td>");
