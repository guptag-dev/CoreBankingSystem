...
/**
 * Servlet implementation class for Servlet: ChequeCancel
 *
 */
 public class ChequeCancel extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else if(perarray[0]=='e')
			{
				...
				pw.println("<td align=top width=580><script language=Javascript>function validate(){	var myform = document.form1;			if(myform.Chequeno.value==\"\")	{		alert(\"Cheque Number is the required Field\");		return false;	}		}</script><font size=5>Cancel Cheque</font>          <form action=\"CancelDone\" method=\"POST\" name=form1><table>	<td width=200>		<b>Cheque No.:</b><br><br>	</td>	<td>			<input type=\"text\" name=Chequeno maxlength=20><br><br>			</td></table><input type=Submit value=\"Cancel\" onclick=\"return validate()\"> <input type=reset value=\"Reset\"></form></td>");
