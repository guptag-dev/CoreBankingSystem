...
/**
 * Servlet implementation class for Servlet: NewsChange4
 *
 */
 public class NewsChange4 extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			String news=request.getParameter("news5");
			query="update updates set updates.news5='"+news+"'";
			stmt.executeUpdate(query);
			pw.println("<td valign=\"top\" width=580>News Changed Successfully");
