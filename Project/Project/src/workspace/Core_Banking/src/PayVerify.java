...
/**
 * Servlet implementation class for Servlet: PayVerify
 *
 */
 public class PayVerify extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			ctx.setAttribute("ACno",acnum);
				...
				pw.println("</table><br><br><form action=\"DraftPaid\" method=\"POST\"><input type=\"submit\" value=\"Verify\" name=verify></form></td>");
				break;
					}
