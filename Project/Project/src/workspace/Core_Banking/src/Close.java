...
/**
 * Servlet implementation class for Servlet: Close
 *
 */
 public class Close extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else if(perarray[0]=='e')
			{
				...
				String abc="<td valign=top width=580><SCRIPT LANGUAGE=JavaScript>function validate(){   var myForm = document.form1;   if (myForm.acnum.value ==\"\")   {      alert(\"Enter the Account Number to be deleted\");    	return false;     }}</SCRIPT>";
				pw.println(abc+"<font size=2 ><br><br><form name=form1 action=\"VerifySignature\" method=\"POST\"><table >	<td valign=\"top\" >	<b>Account Number :</b>	</td>	<td valign=\"top\" >	<input type=\"text\" maxlength=\"20\" name=acnum size=\"20\" ></td></table><br><input type=\"submit\" value=\"Delete\"  onclick=\"return validate()\">&nbsp&nbsp&nbsp&nbsp&nbsp<input type=\"reset\" value=Reset>	</form></td>");
