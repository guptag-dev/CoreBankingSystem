...
/**
 * Servlet implementation class for Servlet: DraftPay
 *
 */
 public class DraftPay extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else if(perarray[0]=='e')
			{
				...
				pw.println("<td valign=\"top\" width=580><script language=Javascript>function validate(){	var myform = document.form1;		if(myform.Draftno.value==\"\")	{		alert(\"Draft Number is the required Field\");		return false;	}		if(myform.ACno.value==\"\")	{		alert(\"Account Number is the required Field\");		return false;	}	if(myform.medium.value==\"Select One\")	{		alert(\"Select any one Medium\");		return false;	}		}</script><font size=\"6\">Payment</font>          <br><form action=\"PayVerify\" method=\"POST\" name=form1><table>	<td width=200>	<b>Draft Number:</b><br><br>	<b>Medium:</b><br><br><b>Account Number:</b><br><br>			</td>	<td>		<input type=\"text\" name=Draftno maxlength=20><br><br>			<select name=medium>	<option value=\"Select One\">Select One</option>	<option value=\"Self\">Self</option>	<option value=\"Account\">Account</option>	</select><br><br>	<input type=\"text\" name=ACno maxlength=20><br><br>			</td></table><br><br>  <input type=Submit value=\"Submit\" onclick=\"return validate()\"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=reset value=\"Reset\"> </form></td>");
