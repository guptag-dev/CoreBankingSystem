...
/**
 * Servlet implementation class for Servlet: ClearVerify
 *
 */
 public class ClearVerify extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			String acnum = request.getParameter("ACno");
			...
			String Amount = request.getParameter("Amount");
				...
				while(rset.next())
				{
					...
					ctx.setAttribute("Chequeno",Chequeno);
				...
				pw.println("</table><br><br><form action=\"Clear\" method=\"POST\"><input type=\"submit\" value=\"Verify\" name=verify></form></td>");
					}
					else
					pw.println("<td valign=\"top\" width=580><form action=\"Clear\" method=\"POST\"><input type=\"submit\" value=\"Continue\" name=verify></form></td>");
				break;
				}
				if(!enter)
				{
