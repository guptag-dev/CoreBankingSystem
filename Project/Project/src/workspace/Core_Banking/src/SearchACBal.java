...
/**
 * Servlet implementation class for Servlet: SearchACBal
 *
 */
 public class SearchACBal extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='e')
				...
				String start = request.getParameter("bal1");
				String end = request.getParameter("bal2");
				query = "select * from account where account.balance>="+start+" and account.balance<="+end;
				rset=stmt.executeQuery(query);
				pw.println("<td valign=\"top\" width=580><font size=3><U><B>Search Results</U></B></font><br><br><table><tr><td style=\"border:1px #000000 solid\" bgcolor=#b5b5b5>User ID</td><td style=\"border:1px #000000 solid\" bgcolor=#b5b5b5>Account Number</td><td style=\"border:1px #000000 solid\" bgcolor=#b5b5b5>Balance</td></tr>");
				while(rset.next())
				{
					pw.println("<tr><td style=\"border:1px #000000 solid\">"+rset.getString(1)+"</td><td style=\"border:1px #000000 solid\">"+rset.getLong(2)+"</td><td style=\"border:1px #000000 solid\">"+rset.getFloat(6)+"</td></tr>");
				}
