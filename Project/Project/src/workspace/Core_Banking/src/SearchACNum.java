...
/**
 * Servlet implementation class for Servlet: SearchACNum
 *
 */
 public class SearchACNum extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='e')
				...
				String end = request.getParameter("taxtype");
				query = "select * from account where account.accno>="+start+" and account.accno<="+end;
				rset=stmt.executeQuery(query);
				pw.println("<td valign=\"top\"><font size=3><U><B>Search Results</U></B></font><br><br><table><tr><td style=\"border:1px #000000 solid\" bgcolor=#b5b5b5>User ID</td><td style=\"border:1px #000000 solid\" bgcolor=#b5b5b5>Account Number</td><td style=\"border:1px #000000 solid\" bgcolor=#b5b5b5>Balance</td></tr>");
				while(rset.next())
				{
