...
/**
 * Servlet implementation class for Servlet: Guarantee
 *
 */
 public class Guarantee extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='c')
			{
				...
				pw.println("<td valign=\"top\" width=580><font color=\"blue\" size=3>This facility cannot be availed by the Customers. Contact your nearby bank for more details</font></td>");
			...
			else if(perarray[0]=='e')
			{
				...
				pw.println("<td valign=\"top\" width=580><b> <u>Guarantee Section </u></b> <br> <br><br><br> 1) <a href=\"LOGissue\">Letter Of Guarantee Issuing</a><br><br> 2) <a href=\"LOGPay\">Letter Of Guarantee Payment</a><br></td>");
