...
/**
 * Servlet implementation class for Servlet: NewsChange2
 *
 */
 public class NewsChange2 extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			String news=request.getParameter("news3");
			query="update updates set updates.news3='"+news+"'";
