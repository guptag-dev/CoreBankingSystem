...
/**
 * Servlet implementation class for Servlet: Bill
 *
 */
 public class Bill extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(perarray[0]=='c')
			{
				...
				String abc="<td valign=top width=580><SCRIPT LANGUAGE=JavaScript>function validate(){   var myForm = document.form1;   if (myForm.taxtype.value ==\"Select One\")   {      alert(\"Select Type of Bill\");    	return false;     }if (myForm.bill.value ==\"\")   {      alert(\"Enter your Bill Number\");    	return false;     }if (myForm.amt.value ==\"\")   {      alert(\"Enter Bill Amount\");    	return false;     }if (isNaN(myForm.amt.value) ==true)   {      alert(\"Amount should be numeral\");    	return false;     }if (myForm.idnum.value ==\"\")   {      alert(\"Enter Your ID Proof\");    	return false;     }}</SCRIPT>";
			...
			else if(perarray[0]=='e')
			{
				...
				String abc="<td valign=top width=580><SCRIPT LANGUAGE=JavaScript>function validate(){   var myForm = document.form1;   if (myForm.taxtype.value ==\"Select One\")   {      alert(\"Select Type of Bill\");    	return false;     }if (myForm.bill.value ==\"\")   {      alert(\"Enter your Bill Number\");    	return false;     }if (myForm.amt.value ==\"\")   {      alert(\"Enter Bill Amount\");    	return false;     }if (isNaN(myForm.amt.value) ==true)   {      alert(\"Amount should be numeral\");    	return false;     }if (myForm.idnum.value ==\"\")   {      alert(\"Enter Your ID Proof\");    	return false;     }}</SCRIPT>";
				pw.println(abc+"<font color=\"red\"><B>You can pay only your Bills through this</B></font><br><br><form action=\"PayBill\" method=\"POST\" name=form1><font size=\"3\">Bills</font>          <br><br><table>	<td width=200>	<b>Bill Type:</b><br><br>	<b>Bill No.:</b><br><br>	<b>Bill Amount:</b><br><br><b>ID Proof of Depositor:</b><br><br>	</td>	<td>	<select name=taxtype>	<option value=\"Select One\">Select One</option>	<option value=\"electricity\">Electricity</option>	<option value=\"phone\">Phone Bill</option>	<option value=\"water\">Water Bill</option>	</select><br><br><input type=\"text\" name=bill maxlength=20><br><br>	<input type=\"text\" name=amt maxlength=20><br><br><input type=\"text\" name=idnum maxlength=20><br><br><input type=reset value=\"Reset\" name=btnd2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=\"Submit\" value=\"Pay Bill\" name=btnd1 onclick=\"return validate()\">	</td></table> </form></td>");
